...
print(f"State with highest death rate: {state_worst_death}")
print(f"Death rate: {high_death_ratio}%")
print()
print()

print(f"State with lowest death rate: {state_best_death}")
print(f"Death rate: {low_death_ratio}%")
print()
print()

print(f"State with highest test rate: {state_best_test}")
print(f"Test rate: {high_test_ratio}%")
print()
print()

print(f"State with lowest test rate: {state_worst_test}")
